       ...
       <div className='p-8 '  data-aos="fade-up"
        ...
        <div className='text-center py-4  '>
         ...
         <div className='container mx-auto grid md:grid-cols-2 lg:grid-cols-4 grid-cols-1 gap-2'>
            <div className='border p-12 text-center flex flex-col justify-center items-center shadow-lg border-gray-200 rounded-lg transform transition-transform duration-500 ease-in-out hover:scale-105'    
             >
